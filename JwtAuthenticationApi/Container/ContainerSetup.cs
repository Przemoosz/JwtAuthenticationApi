...
//     using Security.Salt;
//     using Services.Abstraction.Factories.Password;
//     using Services.Abstraction.Identity.User;
//     using Services.Abstraction.Registration;
//     using Services.Abstraction.RuleEngine;
...
// 		{
// 			builder.Services.Configure<DatabaseConnectionStrings>(builder.Configuration.GetSection(nameof(DatabaseConnectionStrings)));
